...
\fancyhead[R]{\footnotesize\sansall\color{muted}Group 05}
...
%  Course and department appear once, here under the title, so that the
%  "Prepared for" and "By" blocks below carry only people.
\vspace{1.2em}
{\sansall\bfseries\footnotesize
01204465 Introduction to Data Mining, Data Analytics \& Knowledge Discovery\\[0.55em]
Department of Computer Engineering, Faculty of Engineering\\
Kasetsart University\par}

\vspace{3.0cm}

{\sansall\bfseries\small Prepared for\par}
\vspace{1.0em}
{\sansall\bfseries\small Assoc. Prof. Kitsana Waiyamai, Ph.D.\par}
\vspace{0.55em}
{\sansall\bfseries\footnotesize Instructor\par}

\vspace{2.8cm}

{\sansall\bfseries\small By\par}
\vspace{1.0em}
{\sansall\bfseries\small Group 05\par}
\vspace{1.0em}
{\sansall\small
\begin{tabular}{@{}c@{\hspace{1.1cm}}c@{\hspace{1.1cm}}c@{}}
\bfseries Kitsadee Thongbankao & \bfseries Kawinphop Junjuae & \bfseries Pirapat Rojbadin \\[0.35em]
\footnotesize 6710503721 & \footnotesize 6710503739 & \footnotesize 6710504182
\end{tabular}\par}
