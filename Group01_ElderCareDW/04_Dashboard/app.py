...
with tabs[9]:
    ...
    st.markdown("""
- **เครือของงวดเก่ายังเป็น "ไม่ทราบ"** แฟ้ม ProviderInfo ยุค 2019 และ 2020 ไม่มีคอลัมน์เครือเลย
  ค่าปรับส่วนใหญ่ถูกพบครั้งแรกในงวดเหล่านั้น (เก็บการพบครั้งแรกไว้) จึงมีราว 88% ที่เครือเป็น
  "ไม่ทราบ" — **ไม่ใช่ "ไม่สังกัดเครือ"** การเทียบค่าปรับรายเครือใน BQ8 จึงยังบางอยู่
  ส่วน BQ8 ฝั่งคุณภาพและอัตรากำลัง (อ่านจาก Fact_Facility_Monthly) มีข้อมูลเครือครบตั้งแต่งวด 2020-10
